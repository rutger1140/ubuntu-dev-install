...
#sudo add-apt-repository ppa:agornostal/ulauncher -y # Ulauncher is not available in 24.10 yet
sudo add-apt-repository -y "deb https://ppa.launchpadcontent.net/agornostal/ulauncher/ubuntu/ noble main"
sudo apt update -y
